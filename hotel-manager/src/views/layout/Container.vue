        ...
        <el-aside >
          <el-menu
            ...
            <el-menu-item index="0" @click="handleNav">
              ...
              <span slot="title">酒店管理系统</span>
            </el-menu-item>
            <el-menu-item index="1" @click="navigateTo('/')">
              <i class="el-icon-news"></i>
              <span slot="title">首页</span>
            </el-menu-item>
            <el-menu-item index="2" @click="navigateTo('/roomType')" v-show="role == 'admin' || role == 'operator' ">
              <i class="el-icon-goods"></i>
              <span slot="title">房间类型管理</span>
            </el-menu-item>
            <el-menu-item index="3" @click="navigateTo('/roomInfo')" v-show="role == 'admin' || role == 'operator' || role == 'receptionist' ">
              <i class="el-icon-sold-out"></i>
              <span slot="title">房间信息管理</span>
            </el-menu-item>
            <el-menu-item index="4" @click="navigateTo('/bookingType')" v-show="role == 'admin' || role == 'operator'">
            ...
            <el-menu-item index="6" @click="navigateTo('/order')" v-show="role == 'admin' || role == 'operator' || role =='financial' || role == 'receptionist'">
              <i class="el-icon-mobile-phone"></i>
              <span slot="title">订单信息管理</span>
            </el-menu-item>
            <el-menu-item index="7" @click="navigateTo('/user')"  v-show="role == 'admin' || role == 'operator' || role == 'receptionist'" >
