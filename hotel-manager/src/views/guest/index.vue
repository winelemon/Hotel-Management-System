<template>
  <el-card class="box-card" shadow="always">
    <div slot="header">
      <span>客户信息管理</span>
      <el-input v-model="username" placeholder="根据用户名搜索" style="width: auto;" ></el-input>
      <el-button type="primary" @click = "getByUserName()" style="float: right; padding: 6px 12px" icon="el-icon-search">搜索</el-button>
    </div>
    <el-table
      ref="multipleTable"
      :loading="listLoading"
...
<script>
  import {delUser, getAllUser , getUserByUserName} from "../../api/user";
