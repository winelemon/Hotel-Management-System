  ...
  <el-card class="box-card" shadow="always">
    ...
    <el-table
      ...
      <el-table-column
        ...
        <span v-if="scope.row.role === 'financial'">财务</span>
        <span v-if="scope.row.role === 'admin'">管理员</span>
        <span v-if="scope.row.role === 'operator'">操作员</span>
        <span v-if="scope.row.role === 'receptionist'">前台人员</span>
        </template>
      </el-table-column>
      <el-table-column
        prop="name"
    ...
    <div style="padding: 14px;">
      <div class="bottom">
        <el-button type="primary" @click="navigateTo('add')">添加工作人员</el-button>
      </div>
    </div>
  </el-card>
</template>
