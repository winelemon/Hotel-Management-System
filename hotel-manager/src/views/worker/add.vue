<template>
  <el-card class="app-container" shadow="always">
    ...
    <el-form ref="form1" :model="form1" :rules="rules2" label-width="120px">
      ...
      <el-form-item  label="工作人员角色">
        <el-select  v-model="form1.role" placeholder="请选择工作人员角色">
      <el-option label="操作员"  value="operator"></el-option>
      <el-option label="财务人员"  value="financial"></el-option>
      <el-option label="前台人员"   value="receptionist"></el-option>
    </el-select>
      </el-form-item>
      <el-form-item
        label="地址"
