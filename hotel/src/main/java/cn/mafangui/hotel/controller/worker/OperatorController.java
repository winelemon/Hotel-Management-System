...
public class OperatorController {
    ...
    public AjaxResult getAllOperator(){
        return ResponseTool.success(workerService.selectOperator());
    }
    ...
    public AjaxResult addOperator(String username,String password,String name,String gender,String phone,String email,String address,String role){
        Worker worker = new Worker(username,password,name,gender,phone,email,address,role);
